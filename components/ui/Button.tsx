...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 dark:text-indigo-400 dark:border-indigo-400 dark:hover:bg-indigo-900/20',
  ...
  // Allow overriding default bg colors if className contains bg-
  const variantClass = className.includes('bg-') ? variants[variant].replace(/bg-\w+(-\d+)?/g, '') : variants[variant];
