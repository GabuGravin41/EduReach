...
const SYNONYMS: Record<string, string[]> = {
    ...
    engineering: ['electrical', 'mechanical', 'civil', 'petroleum', 'circuit', 'engineering', 'ku', 'electronics', 'analogue', 'analog', 'thermodynamics', 'fluid', 'eee', 'ecu', 'emm', 'structural', 'aerodynamics'],
    'electrical engineering': ['eee', 'circuit analysis', 'electrical machines', 'power systems', 'electronics', 'electromagnetics', 'circuit', 'electrical measurements', 'instrumentation', 'eee 203', 'eee 204', 'eee 206', 'eee 207', 'eee 208', 'eee 209', 'eee 210'],
    electrical: ['circuit', 'electronics', 'electromagnetics', 'power', 'electrical engineering', 'eee', 'machines', 'transformers', 'instrumentation'],
    circuits: ['circuit theory', 'electrical', 'electronics', 'network analysis', 'circuit analysis', 'inductance', 'resonance'],
    analogue: ['analogue electronics', 'analog electronics', 'amplifier', 'bjt', 'transistor', 'op-amp', 'mosfet', 'fet', 'diode', 'rectifier', 'filter', 'oscillator', 'power amplifier', 'eee 2201', 'eee 3101', 'electronics'],
    analog: ['analogue electronics', 'analog electronics', 'amplifier', 'bjt', 'transistor', 'op-amp', 'mosfet'],
    electronics: ['analogue', 'analog', 'digital electronics', 'transistor', 'amplifier', 'bjt', 'mosfet', 'op-amp', 'diode', 'power systems', 'eee'],
    mechanical: ['thermodynamics', 'fluid mechanics', 'heat transfer', 'machine design', 'emm', 'aerodynamics', 'dynamics', 'statics', 'manufacturing', 'fluid dynamics', 'fluid properties', 'emm 205'],
    'fluid mechanics': ['fluid dynamics', 'fluid statics', 'hydraulics', 'bernoulli', 'flow', 'emm 205', 'eee 209'],
    thermodynamics: ['heat transfer', 'entropy', 'carnot', 'thermal', 'mechanical engineering'],
    civil: ['structural', 'concrete', 'surveying', 'geotechnical', 'highway', 'soil mechanics', 'water supply', 'construction management', 'reinforced concrete', 'steel structures', 'foundation'],
    structural: ['civil engineering', 'structural analysis', 'concrete', 'steel', 'beams', 'columns', 'trusses'],
    petroleum: ['oil', 'gas', 'reservoir engineering', 'drilling', 'petroleum engineering', 'well logging', 'production engineering', 'refinery', 'upstream', 'downstream'],
    'engineering mathematics': ['ecu', 'ode', 'differential equations', 'transform methods', 'laplace', 'fourier', 'calculus', 'numerical methods', 'ecu 200', 'ecu 202', 'ecu 203'],
    computer: ['programming', 'algorithms', 'data structures', 'software', 'databases', 'networks', 'computer science', 'sql', 'database systems'],
    ...
    return (
        <div className="max-w-7xl mx-auto overflow-x-hidden">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-8 gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2 lg:flex-nowrap lg:gap-3 lg:flex-shrink-0">
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-xl text-sm font-bold border-2 transition-all ${
                            ...
                            <div className="p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center gap-3 min-w-0">
                                        <div className="p-2 bg-slate-100 dark:bg-slate-700 rounded-lg group-hover:bg-indigo-50 dark:group-hover:bg-indigo-900/30 transition-colors flex-shrink-0">
                                            {getQuestionTypeIcon(exam.question_types)}
                                        </div>
                                        <div className="min-w-0">
                                            <h3 className="font-bold text-base sm:text-lg text-slate-800 dark:text-slate-100 line-clamp-2">{exam.displayTitle}</h3>
